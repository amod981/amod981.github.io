...
import { BigDataBlog3Meta } from "./BigDataBlog3";

const posts = [
  { meta: BigDataBlog1Meta, to: "/bigDataBlog1" },
  { meta: BigDataBlog2Meta, to: "/bigDataBlog2" },
  { meta: BigDataBlog3Meta, to: "/bigDataBlog3" },
];
